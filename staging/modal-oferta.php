								...
								<div class="col-md-8">
									...
									<div class="text-center w-100 align-items-center text-center align-content-center">
										...
										<div class="btn-group rounded align-items-center text-center align-content-center mx-auto my-auto" role="group" aria-label="Group of buttons"> <!-- Botão de Contato -->
											<a href="https://chat.whatsapp.com/H2iTEX6sBHd6iG86oCobiY" target="_blank" class="btn btn-success btn-rounded fs-6">
											...
											<a href="https://abacate.agr.br" class="btn btn-primary btn-rounded fs-6"><?= translateText('Acessar o site', 'pt') ?></a>
										</div>
									</div>
								</div>
